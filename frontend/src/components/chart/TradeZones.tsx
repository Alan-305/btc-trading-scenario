  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
      <div className="rounded-lg border border-surface-border bg-surface-card p-4">
        ...
        <p className="mt-1 text-sm text-slate-400">{SIDE_LABEL[entry.side]}</p>
        <p className="mt-2 text-xs text-slate-500">{entry.rationale}</p>
      </div>
      <div className="rounded-lg border border-surface-border bg-surface-card p-4">
        ...
        <p className="mt-2 text-xs text-slate-500">{exit.rationale}</p>
      </div>
    </div>
  );
}
